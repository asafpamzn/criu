...
const char *test_doc = "--cow-dump munmap+reuse with UNWRITTEN pages: "
 ...
 */
#ifndef COW_MUNMAP_REUSE_UNWRITTEN_MB
#define COW_MUNMAP_REUSE_UNWRITTEN_MB	64
#endif
#define REGION_MB	COW_MUNMAP_REUSE_UNWRITTEN_MB
 ...
 *
 * The bug: cow_detect_new_vmas() uses address-only comparison. The

...
const char *test_doc = "--cow-dump munmap+reuse test: allocates a large "
...
/*
 * Default 32 GB. Override at build time with -DCOW_MUNMAP_REUSE_MB=N.
 */
#ifndef COW_MUNMAP_REUSE_MB
#define COW_MUNMAP_REUSE_MB	32768		/* 32 GB */
#endif
#define REGION_MB		COW_MUNMAP_REUSE_MB
...
int main(int argc, char **argv)
{
	...
	test_msg("cow_dump_munmap_reuse: REGION=%u MB (%zu pages)\n",
	...
	if (cow_wait_for_drain(region, REGION_BYTES,

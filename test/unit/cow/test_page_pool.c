...
#define UAF_PAGES_PER_ROUND  COW_ALLOC_BATCH
...
static void test_chunk_exhaustion_and_swap(void)
{
	 ...
	 * COW_PAGES_PER_CHUNK - 1 usable pages per chunk (page 0 is header). */
	int alloc_count = COW_PAGES_PER_CHUNK; /* Slightly more than fits */
...
/*
 * Simulate the real COW pattern: producer allocates batches in a loop,
